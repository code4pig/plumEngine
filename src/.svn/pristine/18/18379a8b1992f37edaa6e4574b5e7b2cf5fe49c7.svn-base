...
namespace application
{
	...
	void CApplication::StartNetwork(int32 nettype, const char* ip, int32 port, uint16 limit_msg_num, uint8 limit_invalid_num, bool encrypt, int32 maxclients)
	{
		m_pAsioService->InitNetwork(nettype, m_pNcb);
		m_pAsioService->StartNetwork(nettype, ip, port, limit_msg_num, limit_invalid_num, encrypt, maxclients);
	}
