...
namespace application
{
	...
	bool CNetServer::Start(const char* ip, int32 port, uint16 limit_msg_num, uint8 limit_invalid_num, bool encrypt, int32 maxclients)
	{
		return m_pNetSvr && m_pNetSvr->start(ip, port, limit_msg_num, limit_invalid_num, encrypt, maxclients);
	}
